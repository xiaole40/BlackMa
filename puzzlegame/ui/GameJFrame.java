...
public class GameJFrame extends JFrame implements KeyListener, ActionListener {
    ...
    private void initImage() {
        ...
        if (victory()) {
            //显示胜利图标
            JLabel winJLabel = new JLabel(new ImageIcon("E:\\NGJava\\untitled\\image\\win.png"));
        ...
        //添加背景图片 相对路径
        JLabel backgroud = new JLabel(new ImageIcon("..\\untitled\\image\\background.png"));
    ...
    public void keyReleased(KeyEvent e) {
        //判断游戏是否胜利，如果胜利此方法需要直接结束，不能再执行下面的代码了
        if (victory()) {
            //1.结束方法
            return;
        }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (obj == replayItem){
            ...
            //创建一个管理图片的容器对象JLabel
            JLabel jLabel = new JLabel(new ImageIcon("E:\\NGJava\\untitled\\image\\about.png"));
