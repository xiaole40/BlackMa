...
public class GameJFrame extends JFrame implements KeyListener, ActionListener {
    ...
    //定义一个变量，记录当前展示图片的路径
    String path = "E:\\NGJava\\untitled\\src\\BlackMaNext\\com\\lele\\puzzlegame\\puzzlegame\\image\\girl\\girl1\\";
    ...
    private void initImage() {
        ...
        if (victory()) {
            //显示胜利的图标
            JLabel winJLabel = new JLabel(new ImageIcon("E:\\NGJava\\untitled\\src\\BlackMaNext\\com\\lele\\puzzlegame\\puzzlegame\\image\\win.png"));
        ...
        //添加背景图片
        JLabel background = new JLabel(new ImageIcon("E:\\NGJava\\untitled\\src\\BlackMaNext\\com\\lele\\puzzlegame\\puzzlegame\\image\\background.png"));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (obj == replayItem) {
            ...
            try {
                //可以到本地文件中读取数据
                ObjectInputStream ois = new ObjectInputStream(new FileInputStream("E:\\NGJava\\untitled\\src\\BlackMaNext\\com\\lele\\puzzlegame\\puzzlegame\\save\\save" + index + ".data"));
                gi = (GameInfo)ois.readObject();
                ois.close();
            } catch (IOException ioException) {
                ioException.printStackTrace();
