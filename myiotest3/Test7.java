...
public class Test7 {
    public static void main(String[] args) throws IOException {
        ...
        */
        ...
        //1.读取正确的用户名和密码
        BufferedReader br = new BufferedReader(new FileReader("..\\untitled\\src\\BlackMaNext\\com\\lele\\myiotest3\\userinfo1.txt"));
    ...
    public static void writeInfo(String content) throws IOException {
        BufferedWriter bw = new BufferedWriter(new FileWriter("..\\untitled\\src\\BlackMaNext\\com\\lele\\myiotest3\\userinfo1.txt"));
        bw.write(content);
        bw.close();
    }
}
